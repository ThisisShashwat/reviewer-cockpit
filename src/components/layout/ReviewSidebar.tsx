...
export const ReviewSidebar: React.FC<ReviewSidebarProps> = ({
  ...
  return (
    <aside className="w-80 bg-canvas-card border-r border-border-subtle flex flex-col shrink-0 overflow-y-auto select-none">
      ...
      <div className="p-5 border-b border-border-subtle bg-canvas space-y-3">
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <h1 className="text-base font-bold text-content-primary tracking-tight leading-snug">
              {project.projectName}
            </h1>
            <div className="flex items-center gap-2 mt-1">
              ...
              <span
                className={`px-2 py-0.2 rounded text-[11px] font-mono uppercase font-semibold ${
          ...
          <div className="text-right shrink-0">
            <span className="text-[11px] font-semibold text-content-tertiary uppercase block">
              Claimed
            </span>
        ...
        {/* Quick Links with Copy and Open Actions */}
        <div className="space-y-1.5 pt-1">
          {project.codeUrl && (
            <div className="flex items-center justify-between p-2 rounded-lg bg-canvas-card border border-border-subtle text-xs">
              <div className="flex items-center gap-1.5 min-w-0">
                <FileCode className="w-3.5 h-3.5 text-content-tertiary shrink-0" />
                <span className="font-mono text-content-secondary truncate text-[11px]">
              ...
              <div className="flex items-center gap-1 shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-1 text-content-tertiary hover:text-brand-orange rounded hover:bg-canvas"
          ...
          {project.playableUrl && (
            <div className="flex items-center justify-between p-2 rounded-lg bg-canvas-card border border-border-subtle text-xs">
              <div className="flex items-center gap-1.5 min-w-0">
                <span className="w-1.5 h-1.5 rounded-full bg-semantic-success shrink-0" />
                <span className="font-mono text-content-secondary truncate text-[11px]">
      ...
      {messages.length > 0 && (
        <div className="border-b border-border-subtle">
          <button
            ...
            className="w-full p-3.5 flex items-center justify-between text-xs font-semibold text-content-primary hover:bg-canvas-hover transition-colors"
          >
      ...
      <div className="p-4 border-b border-border-subtle space-y-2">
        ...
        <form onSubmit={handleSaveNote} className="space-y-2">
          ...
          <button
            ...
            className="w-full py-1.5 rounded-lg bg-canvas-subtle border border-border-subtle hover:bg-canvas-hover text-xs font-semibold text-content-primary flex items-center justify-center gap-1.5 transition-colors disabled:opacity-40"
          >
